...
public class EventBus {
    ...
    // added codes
    private boolean checkInmutableEvent = true;
    private IInvokeSubscriber invokeSubscriber = null;
    public void setInvokeSubscriber(IInvokeSubscriber invokeSubscriber) {
        this.invokeSubscriber = invokeSubscriber;
    }

    private void invokeSubscriberBefore(Method method, Object subscriber, Object event) {
        if (invokeSubscriber != null && checkInmutableEvent) {
            invokeSubscriber.invokeSubscriberBefore(method, subscriber, event);
        }
    }

    private void invokeSubscriberAfter(Method method, Object subscriber, Object event) {
        if (invokeSubscriber != null && checkInmutableEvent) {
            invokeSubscriber.invokeSubscriberAfter(method, subscriber, event);
        }
    }

    public void setCheckInmutableEvent(boolean checkInmutableEvent) {
        this.checkInmutableEvent = checkInmutableEvent;
    }

    public boolean isCheckInmutableEvent() {
        return checkInmutableEvent;
    }
}
