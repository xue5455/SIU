...
public class MaskableLayout extends RelativeLayout {
    ...
    public MaskableLayout(Context context) {
        super(context);
    }
    ...
    public MaskableLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskableLayout.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskableLayout.this.getViewTreeObserver();
                    }
    ...
    private void drawNinePath(Canvas canvas) {
        NinePatchDrawable npd = (NinePatchDrawable) mDrawableMask;
