...
public abstract class BaseActionBarFragment<T extends BaseFragmentPresenter> extends BaseFragment<T>{
    ...
    private void initNavigationBar() {
        navigationBarContainer = (FrameLayout) mRootView.findViewById(R.id.navigation_bar_container);
        navigationBar = new NavigationBar(context);
        navigationBarContainer.addView(navigationBar);
        navigationBackground = mRootView.findViewById(R.id.nav_background);
    }
    ...
    private void initContentView() {
        ...
        //默认字号18
        setTitleTextSize(ResourcesUtil.getDimen(R.dimen.text_size_xl));
    }
    ...
    public void setYxNavigationBarWhite(){
