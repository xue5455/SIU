 ...
 */
@TRecycleViewHolderAnnotation(resId = R.layout.item_chat_rcv_image)
public class ImageMsgInViewHolder extends TRecycleViewHolder<MessageUserWrapper> implements View.OnClickListener,
    ...
    public ImageMsgInViewHolder(View itemView, Context context, RecyclerView recyclerView) {
