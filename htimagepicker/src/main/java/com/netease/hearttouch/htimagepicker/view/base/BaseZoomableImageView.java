...
import com.netease.hearttouch.htimagepicker.util.image.SampleSizeUtil;
import com.netease.hearttouch.htimagepicker.view.ImageGestureListener;
...
public abstract class BaseZoomableImageView extends View {
    ...
    public void setImageBitmap(final Bitmap bitmap, final boolean fitScreen) {
        ...
        if (Build.VERSION.SDK_INT >= C.MIN_SDK_ENABLE_LAYER_TYPE_HARDWARE) {
