...
import com.netease.hearttouch.htrecycleview.bga.BGASwipeItemLayout.BottomModel;
import com.netease.hearttouch.htrecycleview.bga.BGASwipeItemLayout.SwipeDirection;
...
@BGARecycleViewHolderAnnotation()
public abstract class BGARecycleViewHolder<TDataModel>
        extends TBaseRecycleViewHolder<BGASwipeItemLayout, TDataModel>
    ...
    public BGARecycleViewHolder(BGASwipeItemLayout itemView,
                                View leftContent,
                                View rightContent,
                                Context context,
