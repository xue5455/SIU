 ...
 */
public class TRecycleViewAdapter<TRealViewHolder extends TRecycleViewHolder, TDataModel>
        extends TBaseRecycleViewAdapter<TRealViewHolder, TDataModel> {
...
//    private int mLimits;
    ...
    public TRecycleViewAdapter(Context context,
